...
contract BetOracleTest is Test {
    ...
    function setUp() public {
        ...
        // Deploy agent wallet
        agentWallet = new BetOracleAgentWallet(
            agentId,
            "Test Agent",
            "https://test.uri",
            owner
    ...
    function test_AgentProfile() public view {
        (bytes32 agentId, string memory name, string memory metadataURI, uint256 createdAt, bool active) = agentWallet.profile();
    ...
    function test_FactoryDeployFull() public {
        ...
        (address wallet, address predContract) = factory.deployFull(
            newAgentId,
            "Factory Agent",
            "https://factory.uri"
        );
